...
import { getServiceVersions, switchServiceVersion, type ServiceVersionInfo } from '@/api/ops/version'
...
function getVersionTagType(svc: ServiceVersionInfo, version: string): 'success' | 'warning' | 'info' {
