...
<template>
  ...
  <div class="login-box" :class="layoutAlign">
    <div class="login-banner">
      <div class="rounded h-8 inset-s-4 inset-t-4 absolute z-1 flex items-center gap-2 font-bold text-lg">
        <span class="inline-flex size-8 items-center justify-center rounded bg-primary text-primary-foreground">O</span>
        OpsManage
      </div>
