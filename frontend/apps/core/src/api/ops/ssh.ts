...
// SSH 账号管理
export const getSSHAccounts = (params?: any) => request.get('/api/security/ssh', { params })
export const createSSHAccount = (data: any) => request.post('/api/security/ssh', data)
...
// 密钥生成
export const generateSSHKeyPair = () => request.post('/api/security/ssh/generate-key')
