...
export function getNginxStatus() {
  return request.get('/api/nginx/status')
}

export function getNginxOverview() {
  return request.get('/api/nginx/overview')
}

export function installNginx() {
  return request.post('/api/nginx/install')
}

export function nginxService(action: string) {
  return request.post('/api/nginx/service', { action })
}

export function testNginxConfig() {
  return request.get('/api/nginx/test')
}

export function importNginxSites() {
  return request.post('/api/nginx/import')
}

// ========== Nginx 站点管理 ==========

export function listNginxSites(params: any) {
  return request.get('/api/nginx/sites', { params })
}

export function createNginxSite(data: any) {
  return request.post('/api/nginx/sites', data)
}
